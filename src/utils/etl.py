...
# se for uma lista, salva o df na variavel output
# caso contrario, armazena em uma lista (aqui dict) para salvar ao final da execucao
# para o ultimo loop salva os dados da camada mais baixa em um arquivo chamdo IBGE
    #TODO: passar todos parametros como esse para o arquivo params e ler eles usando as funcoes do yaml
